      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 sm:gap-8 mb-24">
          <div className="p-6 sm:p-8 bg-neutral-900/20 border border-white/5 rounded-sm relative group hover:border-orange-500/20 transition-all">
            <div className="p-3 bg-neutral-950 border border-white/5 rounded-sm w-fit mb-6 text-orange-500">
             ...
             <h3 className="inner-heading text-xs font-mono font-bold uppercase tracking-widest text-white mb-3">Professional Leadership</h3>
          ...
          <div className="p-6 sm:p-8 bg-neutral-900/20 border border-white/5 rounded-sm relative group hover:border-orange-500/20 transition-all">
            ...
            <h3 className="inner-heading text-xs font-mono font-bold uppercase tracking-widest text-white mb-3">FMCSA & EPA Compliance</h3>
            <p className="inner-text text-xs text-neutral-400 leading-relaxed font-light">
          ...
          <div className="p-6 sm:p-8 bg-neutral-900/20 border border-white/5 rounded-sm relative group hover:border-orange-500/20 transition-all">
            ...
            <h3 className="inner-heading text-xs font-mono font-bold uppercase tracking-widest text-white mb-3">Shipper-First Relations</h3>
            <p className="inner-text text-xs text-neutral-400 leading-relaxed font-light">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-24 items-center border-t border-white/5 pt-16">
          <div className="lg:col-span- così lg:col-span-6">
            <span className="eyebrow-heading text-orange-500 block mb-3">The Corporate Mission</span>
            <h2 className="secondary-heading text-2xl sm:text-4xl font-medium text-white mb-6">
              THE POWER TO RE-ROUTE ROAD TRAFFIC.
            </h2>
            <p className="main-text text-xs sm:text-sm text-neutral-400 leading-relaxed font-light space-y-4">
            ...
            <p className="main-text text-xs sm:text-sm text-neutral-400 leading-relaxed font-light mt-4">
          ...
          <div className="lg:col-span- così lg:col-span-6 bg-neutral-900/30 border border-white/5 p-6 sm:p-8 rounded-sm grid grid-cols-2 gap-6 relative overflow-hidden">
            ...
            <div className="inner-text bg-neutral-950/60 p-4 border border-white/5 rounded-sm font-mono text-[11px]">
              <span className="inner-text text-neutral-500 uppercase block">Active Fleet Power</span>
              <span className="inner-heading text-white text-lg font-bold block mt-1">450+ Tractors</span>
              <span className="inner-text text-neutral-500 text-[11px] block mt-1">Class-8 Heavy Spec</span>
            </div>

            <div className="inner-text bg-neutral-950/60 p-4 border border-white/5 rounded-sm font-mono text-[11px]">
              <span className="inner-text text-neutral-500 uppercase block">Terminal Hubs</span>
              <span className="inner-heading text-[#f97316] text-lg font-bold block mt-1">7 Locations</span>
              <span className="inner-text text-neutral-500 text-[11px] block mt-1">Secure Load Yards</span>
            </div>

            <div className="inner-text bg-neutral-950/60 p-4 border border-white/5 rounded-sm font-mono text-[11px]">
              <span className="inner-text text-neutral-500 uppercase block">Annual Logged Miles</span>
              <span className="inner-heading text-white text-lg font-bold block mt-1">32,450,000+</span>
              <span className="inner-text text-neutral-500 text-[11px] block mt-1">Active GPS Tracks</span>
            </div>

            <div className="inner-text bg-neutral-950/60 p-4 border border-white/5 rounded-sm font-mono text-[11px]">
              <span className="inner-text text-neutral-500 uppercase block">Average Asset Age</span>
              <span className="inner-heading text-white text-lg font-bold block mt-1">1.8 Years</span>
              <span className="inner-text text-neutral-500 text-[11px] block mt-1">Late-Model Kenworths</span>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-16">
          <div className="max-w-3xl mb-12">
            <span className="eyebrow-heading text-[#f97316] block mb-2">Growth Map</span>
            <h2 className="secondary-heading text-2xl sm:text-3xl font-medium text-white">THE CORPORATE CHRONICLER</h2>
          </div>
          ...
          <div ref={timelineRef} className="grid grid-cols-1 md:grid-cols-4 gap-8">
            {HISTORY_TIMELINE.map((item, idx) => (
              ...
              >
                <div className="inner-heading text-lg font-mono text-[#f97316] flex items-center justify-between border-b border-white/5 pb-2">
                  <span>{item.year}</span>
                  <span className="inner-text text-[11px] font-mono font-normal uppercase text-neutral-500">Stage 0{idx + 1}</span>
                </div>
                <div>
                  <h3 className="inner-heading font-mono text-xs font-bold uppercase tracking-wider text-white mb-1">{item.title}</h3>
                  <p className="inner-text text-[11px] text-neutral-400 font-light leading-relaxed">{item.detail}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="mt-20 border-t border-white/5 pt-12 flex flex-col sm:flex-row justify-between items-center gap-6 font-mono text-xs uppercase">
          <div>
            <span className="inner-text text-neutral-500 block">Sustain your supply chain predictability</span>
            <span className="inner-heading text-white font-bold">Request a contract freight quotation</span>
          </div>
