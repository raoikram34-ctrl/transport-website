      ...
      <div className="max-w-7xl mx-auto px-6 sm:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-20">
          <div className="bg-neutral-900/20 border border-white/5 p-6 rounded-sm relative group">
            ...
            <h3 className="inner-heading text-xs font-mono uppercase tracking-widest font-bold text-white mb-2">High CPM Industry Pay</h3>
            <p className="inner-text text-[11px] text-neutral-400 font-light leading-relaxed">
          ...
          <div className="bg-neutral-900/20 border border-white/5 p-6 rounded-sm relative group">
            ...
            <h3 className="inner-heading text-xs font-mono uppercase tracking-widest font-bold text-white mb-2">Late Model Sleepers</h3>
            <p className="inner-text text-[11px] text-neutral-400 font-light leading-relaxed">
          ...
          <div className="bg-neutral-900/20 border border-white/5 p-6 rounded-sm relative group">
            ...
            <h3 className="inner-heading text-xs font-mono uppercase tracking-widest font-bold text-white mb-2">PPO Health / 401k MATCH</h3>
            <p className="inner-text text-[11px] text-neutral-400 font-light leading-relaxed">
          ...
          <div className="bg-neutral-900/20 border border-white/5 p-6 rounded-sm relative group">
            ...
            <h3 className="inner-heading text-xs font-mono uppercase tracking-widest font-bold text-white mb-2">Steady Hometime Reset</h3>
            <p className="inner-text text-[11px] text-neutral-400 font-light leading-relaxed">
        ...
        <h2 className="eyebrow-heading text-neutral-500 mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 mb-20 items-stretch">
          ...
          <div className="lg:col-span- così lg:col-span-7 space-y-4">
            {CDL_SPECS.map((item, idx) => (
              ...
              >
                <div>
                  <h3 className="inner-heading font-bold text-sm uppercase text-white tracking-wide mb-1">{item.title}</h3>
                  <p className="inner-text text-xs text-neutral-400 font-light leading-relaxed">{item.mileage}</p>
                  <p className="inner-text text-[11px] text-neutral-500 font-mono mt-1 uppercase">✓ {item.hometime}</p>
                </div>
                <div className="bg-neutral-950 border border-white/5 px-4 py-2 rounded-sm text-center font-mono self-start sm:self-auto">
                  <span className="inner-heading text-orange-500 font-bold text-xs uppercase block">Tariff Rate</span>
                  <span className="inner-heading text-white font-black text-xs">{item.rate}</span>
                </div>
              </div>
            ))}
          </div>
          ...
          <div className="lg:col-span-5 bg-[#0a0a0c] border border-white/5 p-6 sm:p-8 rounded-sm relative">
            <AnimatePresence mode="wait">
              {!driverApplied ? (
                <motion.div key="prelim-apply-form">
                  <span className="block eyebrow-heading text-neutral-500 mb-6 font-bold">
                    PRELIMINARY APPLICATION GATEWAY
                  </span>

                  <form onSubmit={handleApplyDriver} className="flex flex-col gap-4">
                    <div className="flex flex-col gap-1.5">
                      <label className="inner-heading text-xs font-mono text-neutral-500 uppercase font-bold">Applicant Name</label>
                      <input
                        type="text"
                        required
                        value={driverName}
                    ...
                    <div className="flex flex-col gap-1.5">
                      <label className="inner-heading text-xs font-mono text-neutral-500 uppercase font-bold">Mobile Phone / Tel</label>
                      <input
                        type="tel"
                        required
                        value={driverMobile}
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="flex flex-col gap-1.5">
                        <label className="inner-heading text-xs font-mono text-neutral-500 uppercase font-bold">CDL Class</label>
                        <select
                          value={driverLicense}
                      ...
                      <div className="flex flex-col gap-1.5">
                        <label className="inner-heading text-xs font-mono text-neutral-500 uppercase font-bold">Road Exp (Years)</label>
                        <select
                ...
                >
                  ...
                  <h3 className="inner-heading font-bold text-white uppercase tracking-wider text-base">
                    Prelim Record Lodged
                  </h3>
                  <p className="inner-text text-xs text-neutral-400 leading-relaxed font-light mt-4">
                  ...
                  <button
                    ...
                    className="inner-heading mt-6 text-[10px] font-mono text-orange-500 uppercase tracking-widest hover:underline cursor-pointer"
                  >
