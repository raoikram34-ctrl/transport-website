...
export default function Footer() {
  ...
  return (
    <footer aria-label="Enterprise Footer" className="relative border-t border-white/5 bg-black/80 backdrop-blur-md text-white py-16 px-6 sm:px-12 z-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
        ...
        <div id="footer-identity" className="flex flex-col gap-5 md:col-span-1">
          <div className="flex items-center gap-3">
            ...
            <span className="inner-heading text-md font-bold tracking-tighter uppercase">
              SKYHAUL<span className="text-orange-500 font-extralight opacity-80">TRANSIT</span>
            </span>
          </div>
          <p className="inner-text text-xs text-neutral-400 font-sans tracking-wide leading-relaxed max-w-xs">
            Architecting the future of North American haulage through integrated logistics and deep structural fleet reliability.
          </p>
          <div className="inner-text flex flex-col gap-1 mt-2 text-[11px] font-mono text-neutral-500 uppercase">
        ...
        <div id="footer-navigation" className="grid grid-cols-2 gap-8 md:col-span-2">
          <div>
            <span className="block eyebrow-heading text-neutral-500 mb-4 font-bold">Solutions</span>
            <ul className="inner-text flex flex-col gap-2.5 text-xs text-neutral-400 font-sans">
          ...
          <div>
            <span className="block eyebrow-heading text-neutral-500 mb-4 font-bold">Operations</span>
            <ul className="inner-text flex flex-col gap-2.5 text-xs text-neutral-400 font-sans">
        ...
        {/* Subscribe & Live Stats */}
         <div id="footer-subscribe" className="flex flex-col gap-5">
          <div>
            <span className="block eyebrow-heading text-neutral-500 mb-4 font-bold">Dispatch Updates</span>
            <form onSubmit={handleSubscribe} className="flex h-10 border border-white/10 rounded-sm overflow-hidden bg-neutral-950">
              <input
                ...
                className="inner-text flex-1 bg-transparent px-3 text-xs text-white focus:outline-none placeholder-neutral-600 focus:placeholder-transparent"
              />
              <button
                type="submit"
              ...
              >
                <Mail className="w-3.5 h-3.5" />
                    ...
                    {/* Security / Compliance */}
          <div className="inner-text flex items-center gap-3 border-t border-white/5 pt-4 text-neutral-500 font-mono text-[11px] uppercase tracking-wider">
      ...
      <div className="inner-text max-w-7xl mx-auto pt-8 border-t border-white/5 flex flex-col sm:flex-row justify-between items-center gap-6 font-mono text-[11px] text-neutral-500 uppercase tracking-widest">
        ...
        <button
          onClick={scrollToTop}
          className="inner-heading flex items-center gap-2 group text-neutral-400 hover:text-orange-500 transition-colors focus:outline-none focus:ring-1 focus:ring-orange-500 rounded px-2 py-1 cursor-pointer"
        >
